...
function render(variables = {}) {
  ...
  if (!variables.name) variables.name = "Vicente";
  if (!variables.lastName) variables.lastName = "Torres";
  if (!variables.role) variables.role = "Web Developer";
  if (!variables.country) variables.country = "España";
  if (!variables.city) variables.city = "Miramar";
